<x-app-layout>
    <div class="container py-5">
        <div class="row mb-4">
            <div class="col">
                <h1 class="h2">Editar Recomendação</h1>
            </div>
        </div>
                ...
                <form action="{{ route('admin.recommendations.update', $recommendation->id) }}" method="POST">
                        ...
                        <select class="form-select form-select-lg @error('car_model_id') is-invalid @enderror" id="car_model_id" name="car_model_id" required>
                            ...
                            @foreach ($carModels as $model)
                                <option value="{{ $model->id }}" 
                                    {{ old('car_model_id', $recommendation->car_model_id) == $model->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number"
                            ...
                            id="year"
                            name="year"
                            value="{{ old('year', $recommendation->year) }}"
                            min="1990"
                            max="{{ date('Y') + 1 }}"
                            required>
                        @error('year')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('recommended_oil', $recommendation->recommended_oil) }}"
                            required>
